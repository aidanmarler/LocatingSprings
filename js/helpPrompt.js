...
helpWindow.innerHTML += "<br><br><br> <i>For more assitance with the application, see <b><a href='https://youtu.be/Aonnehx7d1k' target='_blank'>this video.</a></b> Or, you can email us at <a href='mailto:aima7917@colorado.edu' target='_blank'>aima7917@colorado.edu</a>.</i>"
helpWindow.innerHTML += "<br> We sourced our <a href='https://mrdata.usgs.gov/geology/state/state.php?state=NE' target='_blank'>data on geology from here</a>, our <a href='https://apps.nationalmap.gov/downloader/' target='_blank'>data on topography and hydrology here</a>, and our <a href='https://data.nal.usda.gov/dataset/gridded-soil-survey-geographic-database-gssurgo' target='_blank'>and our data on soils from here</a>."
